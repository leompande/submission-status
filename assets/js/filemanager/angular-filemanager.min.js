!function (e, r, n) {
    ...
    r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]), n(e.document).on("shown.bs.modal", ".modal", function () {
        ...
        var a = n("#context-menu");
        r.pageX >= e.innerWidth - a.width() && (r.pageX -= a.width()), r.pageY >= e.innerHeight - a.height() && (r.pageY -= a.height()), a.hide().css({
            left: r.pageX,
            top: r.pageY
        ...
        for (var r, n = Object(this), a = n.length >>> 0, i = arguments[1], t = 0; a > t; t++)if (r = n[t], e.call(i, r, t, n))return r;
        return void 0
    })
}(window, angular, jQuery), function (e) {
    "use strict";
    ...
    r.directive("angularFilemanager", ["$parse", "fileManagerConfig", function (e, r) {
        ...
        return {
            restrict: "A", link: function (r, n, a) {
                var i = e(a.ngFile), t = i.assign;
        ...
        return function (r, n, a) {
            var i = e(a.ngRightClick);
            n.bind("contextmenu", function (e) {
                r.$apply(function () {
                    e.preventDefault(), i(r, {$event: e})
                })
            })
        }
    }])
    ...
    "use strict";
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (e, n, a, i, t, o, s, l) {
        a.translate = i;
        ...
        e.config = t, e.reverse = !1, e.predicate = ["model.type", "model.name"], e.order = function (r) {
        ...
        }, e.query = "", e.fileNavigator = new s, e.apiMiddleware = new l, e.uploadFileList = [], e.viewTemplate = d.getItem("viewTemplate") || "main-table.html", e.fileList = [], e.temps = [], e.$watch("temps", function () {
            ...
            if (!(!r || i && e.isSelected(r))) {
                ...
                return n && n.ctrlKey && !i ? void(e.isSelected(r) ? e.temps.splice(a, 1) : e.temps.push(r)) : void(e.temps = [r])
            }
            ...
            return r.isFolder() ? e.fileNavigator.folderClick(r) : r.isImage() ? e.config.previewImagesInModal ? e.openImagePreview(r) : e.apiMiddleware.download(r, !0) : r.isEditable() ? e.openEditItem(r) : void 0
        ...
        }, e.modal = function (n, a, i) {
            var t = r("#" + n);
            return t.modal(a ? "hide" : "show"), e.apiMiddleware.apiHandler.error = "", e.apiMiddleware.apiHandler.asyncSuccess = !1, i ? t : !0
            ...
            var r = e.singleSelection();
            if (r) {
                var a = r.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(a);
                if (t && c(r))return e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1;
                if (!a)return e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1
            }
            e.apiMiddleware.copy(e.temps, n.selectedModalPath).then(function () {
                e.fileNavigator.refresh(), e.modal("copy", !0)
            })
        }, e.compress = function () {
            var r = e.temp.tempModel.name.trim(), a = e.fileNavigator.fileNameExists(r);
            return a && c(e.temp) ? (e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1) : r ? void e.apiMiddleware.compress(e.temps, r, n.selectedModalPath).then(function () {
            ...
            }) : (e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1)
        }, e.extract = function () {
            var r = e.temp, a = e.temp.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(a);
            return t && c(e.temp) ? (e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1) : a ? void e.apiMiddleware.extract(r, a, n.selectedModalPath).then(function () {
            ...
            return r && c(r) ? (e.apiMiddleware.apiHandler.error = i.instant("error_cannot_move_same_path"), !1) : void e.apiMiddleware.move(e.temps, n.selectedModalPath).then(function () {
                e.fileNavigator.refresh(), e.modal("move", !0)
            })
        }, e.rename = function () {
            var r = e.singleSelection(), n = r.tempModel.name, a = r.tempModel.path.join("") === r.model.path.join("");
            return !n || a && e.fileNavigator.fileNameExists(n) ? (e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename"), !1) : void e.apiMiddleware.rename(r).then(function () {
                e.fileNavigator.refresh(), e.modal("rename", !0)
            })
        }, e.createFolder = function () {
            var r = e.singleSelection(), n = r.tempModel.name;
            return !n || e.fileNavigator.fileNameExists(n) ? e.apiMiddleware.apiHandler.error = i.instant("error_invalid_filename") : void e.apiMiddleware.createFolder(r).then(function () {
            ...
            e.apiMiddleware.upload(e.uploadFileList, e.fileNavigator.currentPath).then(function () {
                ...
                var n = r.result && r.result.error || i.instant("error_uploading_files");
                e.apiMiddleware.apiHandler.error = n
            })
        };
        var c = function (e) {
            var r = n.selectedModalPath.join(""), a = e && e.model.path.join("");
            return a === r
        }, p = function (e) {
            var r = a.location.search.substr(1).split("&").filter(function (r) {
                return e === r.split("=")[0]
            });
    ...
    e.module("FileManagerApp").controller("ModalFileManagerCtrl", ["$scope", "$rootScope", "fileNavigator", function (e, r, n) {
        e.reverse = !1, e.predicate = ["model.type", "model.name"], e.fileNavigator = new n, r.selectedModalPath = [], e.order = function (r) {
            ...
            var n = r.selectedModalPath.filter(Boolean), a = "/" + n.join("/");
            return e.singleSelection() && !e.singleSelection().isFolder() && (a += "/" + e.singleSelection().tempModel.name), a.replace(/\/\//, "/")
        }
    }])
}(angular), function (e) {
    "use strict";
    ...
    r.filter("strLimit", ["$filter", function (e) {
        ...
        var n = [" kB", " MB", " GB", " TB", "PB", "EB", "ZB", "YB"], a = ["KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"];
        return function (e) {
            var i = -1, t = e;
            do t /= 1024, i++; while (t > 1024);
            var o = r.useBinarySizePrefixes ? a[i] : n[i];
    ...
    e.module("FileManagerApp").provider("fileManagerConfig", function () {
        var r = {
            ...
            removeUrl: "data.json",
            editUrl: "data.json",
            getContentUrl: "data.json",
            createFolderUrl: "data.json",
            downloadFileUrl: "data.json",
            downloadMultipleUrl: "data.json",
            compressUrl: "data.json",
            extractUrl: "data.json",
            permissionsUrl: "data.json",
            searchForm: !0,
            sidebar: !0,
            breadcrumb: !0,
            allowedActions: {
    ...
    "use strict";
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function (e, n, a, i, t) {
        e.defaults.headers.common["X-Requested-With"] = "XMLHttpRequest";
        var o = function () {
            this.inprocess = !1, this.asyncSuccess = !1, this.error = ""
        };
        return o.prototype.deferredHandler = function (e, r, n) {
            return e && "object" == typeof e || (this.error = "Bridge response error, please check the docs"), e.result && e.result.error && (this.error = e.result.error), !this.error && e.error && (this.error = e.error.message), !this.error && n && (this.error = n), this.error ? r.reject(e) : r.resolve(e)
        }, o.prototype.list = function (r, a, i) {
            var t = this, o = i || t.deferredHandler, s = n.defer(), l = {action: "list", path: a};
            return t.inprocess = !0, t.error = "", e.get(r, l).success(function (e) {
                o(e, s)
            }).error(function (e) {
                o(e, s, "Unknown error listing, check the response")
            })["finally"](function () {
                t.inprocess = !1
            }), s.promise
        }, o.prototype.copy = function (r, a, t) {
            var o = this, s = n.defer(), l = {action: "copy", items: a, newPath: t};
            return o.inprocess = !0, o.error = "", e.get(r, l).success(function (e) {
                o.deferredHandler(e, s)
            }).error(function (e) {
                o.deferredHandler(e, s, i.instant("error_copying"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
        }, o.prototype.move = function (r, a, t) {
            var o = this, s = n.defer(), l = {action: "move", items: a, newPath: t};
            return o.inprocess = !0, o.error = "", e.get(r, l).success(function (e) {
                o.deferredHandler(e, s)
            }).error(function (e) {
                o.deferredHandler(e, s, i.instant("error_moving"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
        }, o.prototype.remove = function (r, a) {
            var t = this, o = n.defer(), s = {action: "remove", items: a};
            return t.inprocess = !0, t.error = "", e.get(r, s).success(function (e) {
                t.deferredHandler(e, o)
            }).error(function (e) {
                t.deferredHandler(e, o, i.instant("error_deleting"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
        }, o.prototype.upload = function (e, r, a) {
            var i = this, o = n.defer();
            i.inprocess = !0, i.progress = 0, i.error = "";
            for (var s = {destination: r}, l = 0; l < a.length; l++)s["file-" + l] = a[l];
            return a && a.length && t.upload({url: e, data: s}).then(function (e) {
                i.deferredHandler(e, o)
            }, function (e) {
                i.deferredHandler(e, o, "Unknown error uploading files")
            }, function (e) {
                i.progress = Math.min(100, parseInt(100 * e.loaded / e.total)) - 1
            })["finally"](function () {
                i.inprocess = !1, i.progress = 0
            }), o.promise
        }, o.prototype.getContent = function (r, a) {
            var t = this, o = n.defer(), s = {action: "getContent", item: a};
            return t.inprocess = !0, t.error = "", e.get(r, s).success(function (e) {
                t.deferredHandler(e, o)
            }).error(function (e) {
                t.deferredHandler(e, o, i.instant("error_getting_content"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
        }, o.prototype.edit = function (r, a, t) {
            var o = this, s = n.defer(), l = {action: "edit", item: a, content: t};
            return o.inprocess = !0, o.error = "", e.get(r, l).success(function (e) {
                o.deferredHandler(e, s)
            }).error(function (e) {
                o.deferredHandler(e, s, i.instant("error_modifying"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
        }, o.prototype.rename = function (r, a, t) {
            var o = this, s = n.defer(), l = {action: "rename", item: a, newItemPath: t};
            return o.inprocess = !0, o.error = "", e.get(r, l).success(function (e) {
                o.deferredHandler(e, s)
            }).error(function (e) {
                o.deferredHandler(e, s, i.instant("error_renaming"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
        }, o.prototype.getUrl = function (e, n) {
            var a = {action: "download", path: n};
            return n && [e, r.param(a)].join("?")
        }, o.prototype.download = function (r, t, o, s, l) {
            var d = this, c = this.getUrl(r, t);
            if (!s || l || !a.saveAs)return !a.saveAs && a.console.error("Your browser dont support ajax download, downloading by default"), !!a.open(c, "_blank", "");
            var p = n.defer();
            return d.inprocess = !0, e.get(c).success(function (e) {
                var r = new a.Blob([e]);
                p.resolve(e), a.saveAs(r, o)
            }).error(function (e) {
                d.deferredHandler(e, p, i.instant("error_downloading"))
            })["finally"](function () {
                d.inprocess = !1
            }), p.promise
        }, o.prototype.downloadMultiple = function (t, o, s, l, d) {
            var c = this, p = n.defer(), m = {
                action: "downloadMultiple",
                items: o,
                toFilename: s
            }, u = [t, r.param(m)].join("?");
            return l && !d && a.saveAs ? (c.inprocess = !0, e.get(t).success(function (e) {
                var r = new a.Blob([e]);
                p.resolve(e), a.saveAs(r, s)
            }).error(function (e) {
                c.deferredHandler(e, p, i.instant("error_downloading"))
            })["finally"](function () {
                c.inprocess = !1
            }), p.promise) : (!a.saveAs && a.console.error("Your browser dont support ajax download, downloading by default"), !!a.open(u, "_blank", ""))
        }, o.prototype.compress = function (r, a, t, o) {
            var s = this, l = n.defer(), d = {action: "compress", items: a, destination: o, compressedFilename: t};
            return s.inprocess = !0, s.error = "", e.get(r, d).success(function (e) {
                s.deferredHandler(e, l)
            }).error(function (e) {
                s.deferredHandler(e, l, i.instant("error_compressing"))
            })["finally"](function () {
                s.inprocess = !1
            }), l.promise
        }, o.prototype.extract = function (r, a, t, o) {
            var s = this, l = n.defer(), d = {action: "extract", item: a, destination: o, folderName: t};
            return s.inprocess = !0, s.error = "", e.get(r, d).success(function (e) {
                s.deferredHandler(e, l)
            }).error(function (e) {
                s.deferredHandler(e, l, i.instant("error_extracting"))
            })["finally"](function () {
                s.inprocess = !1
            }), l.promise
        }, o.prototype.changePermissions = function (r, a, t, o, s) {
            var l = this, d = n.defer(), c = {
            ...
            return l.inprocess = !0, l.error = "", e.get(r, c).success(function (e) {
                l.deferredHandler(e, d)
            }).error(function (e) {
                l.deferredHandler(e, d, i.instant("error_changing_perms"))
            })["finally"](function () {
                l.inprocess = !1
            }), d.promise
        }, o.prototype.createFolder = function (r, a) {
            var t = this, o = n.defer(), s = {action: "createFolder", newPath: a};
            return t.inprocess = !0, t.error = "", e.get(r, s).success(function (e) {
                t.deferredHandler(e, o)
            }).error(function (e) {
                t.deferredHandler(e, o, i.instant("error_creating_folder"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
        }, o
    ...
    e.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, r, n) {
        ...
        return a.prototype.getPath = function (e) {
            return "/" + e.join("/")
        }, a.prototype.getFileList = function (e) {
            return (e || []).map(function (e) {
                return e && e.model.fullPath()
            })
        }, a.prototype.getFilePath = function (e) {
            return e && e.model.fullPath()
        }, a.prototype.list = function (e, n) {
            return this.apiHandler.list(r.listUrl, this.getPath(e), n)
        }, a.prototype.copy = function (e, n) {
            var a = this.getFileList(e);
            return this.apiHandler.copy(r.copyUrl, a, this.getPath(n))
        }, a.prototype.move = function (e, n) {
            var a = this.getFileList(e);
            return this.apiHandler.move(r.moveUrl, a, this.getPath(n))
        }, a.prototype.remove = function (e) {
            var n = this.getFileList(e);
            return this.apiHandler.remove(r.removeUrl, n)
        }, a.prototype.upload = function (n, a) {
            if (!e.FormData)throw new Error("Unsupported browser version");
            var i = this.getPath(a);
            return this.apiHandler.upload(r.uploadUrl, i, n)
        }, a.prototype.getContent = function (e) {
        ...
        }, a.prototype.rename = function (e) {
            var n = this.getFilePath(e), a = e.tempModel.fullPath();
            return this.apiHandler.rename(r.renameUrl, n, a)
        }, a.prototype.getUrl = function (e) {
            var n = this.getFilePath(e);
            return this.apiHandler.getUrl(r.downloadFileUrl, n)
        }, a.prototype.download = function (e, n) {
            var a = this.getFilePath(e), i = e.model.name;
            return e.isFolder() ? void 0 : this.apiHandler.download(r.downloadFileUrl, a, i, r.downloadFilesByAjax, n)
        }, a.prototype.downloadMultiple = function (e, n) {
            var a = this.getFileList(e), i = (new Date).getTime().toString().substr(8, 13), t = i + "-" + r.multipleDownloadFileName;
            return this.apiHandler.downloadMultiple(r.downloadMultipleUrl, a, t, r.downloadFilesByAjax, n)
        }, a.prototype.compress = function (e, n, a) {
            var i = this.getFileList(e);
            return this.apiHandler.compress(r.compressUrl, i, n, this.getPath(a))
        }, a.prototype.extract = function (e, n, a) {
            var i = this.getFilePath(e);
            return this.apiHandler.extract(r.extractUrl, i, n, this.getPath(a))
        }, a.prototype.changePermissions = function (e, n) {
            var a = this.getFileList(e), i = n.tempModel.perms.toCode(), t = n.tempModel.perms.toOctal(), o = !!n.tempModel.recursive;
            return this.apiHandler.changePermissions(r.permissionsUrl, a, i, t, o)
        }, a.prototype.createFolder = function (e) {
    ...
    e.module("FileManagerApp").service("fileNavigator", ["apiMiddleware", "fileManagerConfig", "item", function (e, r, n) {
        ...
        return a.prototype.deferredHandler = function (e, r, n) {
            ...
            var e = this, r = e.currentPath.join("/");
            return e.requesting = !0, e.fileList = [], e.list().then(function (a) {
                e.fileList = (a.result || []).map(function (r) {
            ...
            function r(e, n, a) {
                var i = a ? a + "/" + n.model.name : n.model.name;
                if (e.name.trim() && 0 !== a.trim().indexOf(e.name) && (e.nodes = []), e.name !== a)e.nodes.forEach(function (e) {
                    r(e, n, a)
                }); else {
                    for (var t in e.nodes)if (e.nodes[t].name === i)return;
                    e.nodes.push({item: n, name: i, nodes: []})
                }
            ...
            !this.history.length && this.history.push({
                name: "",
                nodes: []
            }), a(this.history[0], t), o = i(t, e), o && (o.nodes = []);
    ...
    e.module("FileManagerApp").service("chmod", function () {
        ...
        return e.prototype.toOctal = function (e, r) {
            ...
            if (e = ("" + e).replace(/\s/g, ""), e = 10 === e.length ? e.substr(1) : e, /^[-rwxts]{9}$/.test(e)) {
                ...
                for (var a in n) {
                    var i = this.getRwxObj();
                    i.read = /r/.test(n[a]), i.write = /w/.test(n[a]), i.exec = /x|t/.test(n[a]), r.push(i)
                }
            ...
            if (e = ("" + e).replace(/\s/g, ""), e = 4 === e.length ? e.substr(1) : e, /^[0-7]{3}$/.test(e)) {
                ...
                for (var a in n) {
                    var i = this.getRwxObj();
                    i.read = /[4567]/.test(n[a]), i.write = /[2367]/.test(n[a]), i.exec = /[1357]/.test(n[a]), r.push(i)
                }
                return {owner: r[0], group: r[1], others: r[2]}
            }
        }, e
    ...
    e.module("FileManagerApp").factory("item", ["fileManagerConfig", "chmod", function (r, n) {
        ...
        }, a.prototype.isEditable = function () {
        ...
        }, a.prototype.isCompressible = function () {
            return this.isFolder()
        }, a.prototype.isExtractable = function () {
